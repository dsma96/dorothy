...
export default function PasswordReset(props: { disableCustomTheme?: boolean }) {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (passwordError || confirmPasswordError || !verified) {
            return;
        }
        ...
        fetch("/api/user/resetPassword", {
            ...
            .then(
                data => {
                    if( data.code == 200 ){
                        showDialog('Changed!', `please login with your new password`, true);
    ...
    return (
        <AppProvider theme={theme}>
            ...
            <PasswordResetContainer direction="column" justifyContent="space-between">
